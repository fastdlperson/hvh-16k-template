...
public Action Command_RageQuit(int client, int args) 
{
	...
	// public shame
	CPrintToChatAll("\x03[nebula]\x01 \x07%s\x01 just rage quit.", name)
...
public Action Command_ResetScore(int client, int args)
{
	...
	{
		CPrintToChat(client, "\x03[nebula]\x01 Your score already is 0.")
	...
	// not public shame
	CPrintToChat(client, "\x03[nebula]\x01 You just reset your score.")
	return Plugin_Handled;
}
